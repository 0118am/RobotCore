...
| ROS C++ Release + LTO 构建 | PASS | `colcon build --packages-select eup_interfaces eup_hardware eup_sensors eup_bringup --cmake-args -DCMAKE_BUILD_TYPE=Release` |
| launch 静态解析 | PASS | `ros2 launch eup_bringup eup_edge_system.launch.py --show-args` |
