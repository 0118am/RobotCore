...
from eup_interfaces.action import RunTrackingExperiment
from eup_interfaces.msg import ControlAuthorityStatus
...
class TrackingExperimentNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter(
            "scenario_config_path", "src/eup_runtime/config/tracking_scenarios.yaml"
        )
