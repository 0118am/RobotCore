...
from robotcore_interfaces.msg import BodyState, PolicyStatus, SafetyEvent
...
class Blackboard(Node):
    ...
    def on_policy(self, msg):
        ...
        self.state["body_policy_ready"] = bool(msg.input_ready and msg.loaded)
        self.state["body_missing_inputs"] = list(msg.missing_inputs)
